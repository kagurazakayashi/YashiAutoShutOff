...
VIAddVersionKey /LANG=${LANG_SimpChinese} "LegalCopyright"   "神楽坂雅詩（CXC）(http://uuu.moe?p=4293)"
...
VIAddVersionKey /LANG=${LANG_SimpChinese} "ProductName"      "雅詩智能關機"
VIAddVersionKey /LANG=${LANG_SimpChinese} "Comments"         "雅詩智能關機(神楽坂雅詩（CXC）)"
VIAddVersionKey /LANG=${LANG_SimpChinese} "CompanyName"      "神楽坂雅詩（CXC）"
VIAddVersionKey /LANG=${LANG_SimpChinese} "LegalCopyright"   "神楽坂雅詩（CXC）(http://uuu.moe?p=4293)"
VIAddVersionKey /LANG=${LANG_SimpChinese} "FileDescription"  "雅詩智能關機"
VIAddVersionKey /LANG=${LANG_SimpChinese} "ProductName"      "雅詩智能關機"
VIAddVersionKey /LANG=${LANG_SimpChinese} "Comments"         "雅詩智能關機(神楽坂雅詩（CXC）)"
VIAddVersionKey /LANG=${LANG_SimpChinese} "CompanyName"      "神楽坂雅詩（CXC）"
VIAddVersionKey /LANG=${LANG_SimpChinese} "LegalCopyright"   "神楽坂雅詩（CXC）(http://uuu.moe?p=4293)"
...
; 创建开始菜单快捷方式
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\灭屏和休眠阻止.lnk" "$INSTDIR\SleepPreventer.exe"
  CreateShortCut "$DESKTOP\灭屏和休眠阻止.lnk" "$INSTDIR\SleepPreventer.exe"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC09} "source+wget|安装wget和源代码下载批处理文件。"
